...
def get_alpha_file(file_path, alpha_path, start_time, end_time):
    # file_path = '/Volumes/James/01_MyProjectTrees/00_GAM/dataset/分钟数据_20211114_all'
    # alpha_path = '/Volumes/James/01_MyProjectTrees/00_GAM/dataset/分钟数据_20211114_all/alpha'
    # start_time = 20210104
    # end_time = 20210630
    day_list = get_time(start_time, end_time)
    for day_time in day_list:
        print(day_time)
        amount, close, high, low, Open, returns, volume, vwap = data_loader(file_path, day_time)
        ...
        alpha_68 = alpha68(high, low, vwap)
